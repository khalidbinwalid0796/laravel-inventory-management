...
<script src="{{ asset('backend/plugins/jquery/jquery.min.js') }}"></script>
 <!-- End jQuery -->
  ...
  <!-- datepicker js & css cdn -->  
  <script src="https://unpkg.com/gijgo@1.9.13/js/gijgo.min.js" type="text/javascript"></script>
  <link href="https://unpkg.com/gijgo@1.9.13/css/gijgo.min.css" rel="stylesheet" type="text/css"/>
  <!-- datepicker js & css cdn end--> 
  <!-- Select2 -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Khalid Bin Walid</a>
        </div>
      </div>
<!-- Sidebar Menu -->
...
@endif
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; Khalid Bin Walid.<a href="http://adminlte.io"></a></strong>
    <div class="float-right d-none d-sm-inline-block">
      <b>Design & Developed by</b> Khalid
    </div>
  </footer>
...
<!-- end handlebars js cdn -->
<!-- Select2 -->
<script src="{{ asset('backend/plugins/select2/js/select2.full.min.js') }}"></script>
<!-- data table script for  -->
<script>
  $(function () {
    $("#example1").DataTable({
      "responsive": true,
...
<!-- image showing script for profile edit page -->
<script type="text/javascript">
