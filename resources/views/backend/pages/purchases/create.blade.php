...
<!-- Content Wrapper. Contains page content -->
  ...
  <!--purchase table ar sob field
    date,purchase_no,supplier_id,category_id,product_id,
    buying_qty,unit_price,description,buying_price 
  -->
  ...
  <script type="text/javascript">
    $(document).ready(function () {
      $(document).on("click",".addeventmore", function () {
        ...
        //catch foreign, primary key & row te j field gulo show korate chai
        var data= {
                  date:date,
