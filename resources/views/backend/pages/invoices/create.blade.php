...
<!-- Content Wrapper. Contains page content -->
              ...
              <div class="card-body">
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                      <label>Date</label>
                      <input type="text" name="date" id="date" class="form-control-sm datepicker form-control-sm" value="{{ $date }}" placeholder="YYYY-MM-DD" readonly>
                    </div>
              ...
              <div class="card-body">
                <form method="post" action="{{route('invoice.store')}}" id="myForm">
                  ...
                  <table class="table-sm table-bordered" width="100%">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <input type="text" name="discount_amount" value="0" id="discount_amount" class="form-control form-control-sm discount_amount text-right" placeholder="Enter Discount Amount">
                        </td>
                        <td></td>
                      </tr>
                      <tr>
                  ...
                  <div class="form-row new_customer" style="display: none;">
                    ...
                    <div class="form-group col-md-4">
                      <input type="text" name="mobile_no" id="mobile_no" class="form-control form-control-sm" placeholder="Enter Customer Mobile No">
                    </div>
                    <div class="form-group col-md-4">
  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      //Minus discount amount from total amount in invoice        
