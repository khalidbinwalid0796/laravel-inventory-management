        ...
        <table width="100%">
          <tbody>
            <tr>
              ...
              <td width="25%"><p><strong>Name :</strong>{{ $invoice['payment']['customer']['name'] }}</p></td>
              <td width="25%"><p><strong>Mobile No :</strong>{{ $invoice['payment']['customer']['mobile_no'] }}</p></td>
              <td width="35%"><p><strong>Address :</strong>{{ $invoice['payment']['customer']['address'] }}</p></td>
            </tr>
            <tr>
              <td width="15%"></td>
        ...
        <table border="1" width="100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center"><strong>{{$invoice['payment']['discount_amount']}}</strong></td>
            </tr>
            <tr>
              <td colspan="6" class="text-right"><strong>Paid Amount</strong></td>
              <td class="text-center"><strong>{{$invoice['payment']['paid_amount']}}</strong></td>
            </tr>
            <tr>
              <td colspan="6" class="text-right"><strong>Due Amount</strong></td>
              <td class="text-center"><strong>{{$invoice['payment']['due_amount']}}</strong></td>
            </tr>
            <tr>
              <td colspan="6" class="text-right"><strong>Grand Total</strong></td>
              <td class="text-center"><strong>{{$invoice['payment']['total_amount']}}</strong></td>
            </tr>                                                
          </tbody>
        </table>          
        <br>
